      ...
      <div className="space-y-6">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-sm text-base-content/70">
            What theme are you feeling today?
          </p>
        </div>
        ...
        <div className="overflow-hidden shadow-lg rounded-xl border-base-300 bg-base-100">
              ...
              <div className="overflow-hidden shadow-sm bg-base-100 rounded-xl">
                <div className="px-4 py-3 border-b border-base-300 bg-base-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="text-sm font-medium">Jackson Wang</h3>
